    ...
    return (
        ...
        <footer className="">
            <div className="w-full">
                <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4 bg-sky-900">
                    <div>
                ...
                <div className="px-4 py-6 bg-gray-900 text-white md:flex md:items-center md:justify-between">
